...
## Augmented Model - Polynomial log.lvmi

```{r Augmented Model Poly}
...
# Calculate Brier score and AUC for the augmented model
score_augmented <- Score(list(survival = Surv(data$fuyrs, data$status)), 
                         formula = ~ risk_augmented, 
                         data = data,
                         times = c(1, 2, 3), # specify the times at which to calculate the scores
                         cause = 1,
                         estimator = "brier",
