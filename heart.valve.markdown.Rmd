...
# This helps to verify if linear terms in the model are appropriate or need transformation
...
par(mfrow=c(2, 1))  # Layout for plots, adjust depending on number of continuous variables
